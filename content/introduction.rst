...
.. note::
   ...
   The installation of OTOBO is explained in a separate `Installation Guide <https://doc.otobo.org/doc/manual/installation/7.0/en/>`__. To install OTOBO or upgrade OTOBO from a previous version, follow the steps describe there.
