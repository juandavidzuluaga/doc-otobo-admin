...
Use this screen to manage categories available in FAQ articles. A fresh OTOBO installation already contains a category by default. The category management screen is available in the *FAQ Category* module of the *Administration* group.
